...
type CLI struct {
	...
	Sync     cmd.SyncCmd     `cmd:"" help:"Apply declarative config (site, domains, trusts, preview) to the server without deploying."`
	Deploys  cmd.DeploysCmd  `cmd:"" help:"List or prune the deploy history for the site."`
	...
	Trusts   cmd.TrustsCmd   `cmd:"" help:"Manage OIDC deploy trusts."`
